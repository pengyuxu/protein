...
def parse_args():
    ...
    parser.add_argument('--model', default='riconv2_cls_v2_features2_largest', help='model name [default: pointnet_cls]')
    ...
    parser.add_argument('--log_dir', type=str, default='riconv_large_shrec_run2_8k_largest', help='experiment root')
...
def test(model, loader, num_class=40):
    ...
    for j, (points, target) in tqdm(enumerate(loader), total=len(loader)):
        ...
        pred, _ = classifier(points)#, features)
        if len(pred.shape) == 3:
...
def main(args):
    ...
    train_dataset = DataProcessor(root_path, train_data, train_labels, pc_folder="/txt8/")  # , pc_folder="/txt2/")
    test_dataset = DataProcessor(root_path, validation_data, validation_labels, pc_folder="/txt8/")  # , pc_folder="/txt2/")
    ...
    #classifier = model.get_model(num_class, 4, normal_channel=args.use_normals)
